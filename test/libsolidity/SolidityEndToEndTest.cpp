...
BOOST_AUTO_TEST_CASE(shift_right_negative_literal)
{
	char const* sourceCode = R"(
			contract C {
				...
				function f2() pure returns (int) {
					return -4266 >> 1;
				}
				function f3() pure returns (int) {
					return -4266 >> 4;
				}
				function f4() pure returns (int) {
					return -4266 >> 8;
				}
				function f5() pure returns (int) {
					return -4266 >> 16;
				}
				function f6() pure returns (int) {
					return -4266 >> 17;
				}
				function g1() pure returns (int) {
					return -4267 >> 0;
				}
				function g2() pure returns (int) {
					return -4267 >> 1;
				}
				function g3() pure returns (int) {
					return -4267 >> 4;
				}
				function g4() pure returns (int) {
					return -4267 >> 8;
				}
				function g5() pure returns (int) {
					return -4267 >> 16;
				}
				function g6() pure returns (int) {
					return -4267 >> 17;
				}
			}
		)";
	compileAndRun(sourceCode, 0, "C");
	ABI_CHECK(callContractFunction("f1()"), encodeArgs(u256(-4266)));
	ABI_CHECK(callContractFunction("f2()"), encodeArgs(u256(-2133)));
	ABI_CHECK(callContractFunction("f3()"), encodeArgs(u256(-267)));
	ABI_CHECK(callContractFunction("f4()"), encodeArgs(u256(-17)));
	ABI_CHECK(callContractFunction("f5()"), encodeArgs(u256(-1)));
	ABI_CHECK(callContractFunction("f6()"), encodeArgs(u256(-1)));
	ABI_CHECK(callContractFunction("g1()"), encodeArgs(u256(-4267)));
	ABI_CHECK(callContractFunction("g2()"), encodeArgs(u256(-2134)));
	ABI_CHECK(callContractFunction("g3()"), encodeArgs(u256(-267)));
	ABI_CHECK(callContractFunction("g4()"), encodeArgs(u256(-17)));
	ABI_CHECK(callContractFunction("g5()"), encodeArgs(u256(-1)));
	ABI_CHECK(callContractFunction("g6()"), encodeArgs(u256(-1)));
}
